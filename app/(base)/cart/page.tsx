...
import { ArrowLeft, ChevronLeft, ChevronRight, MapPin, Plus, ShoppingBag, Tag, Trash2 } from "lucide-react";
...
export default function CartPage() {
 const { cart, removeFromCart, increaseCart, decreaseCart } = useCartStore();
     ...
     <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
      ...
      <div className="lg:sticky lg:top-24 flex flex-col gap-4">
       ...
       <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-4">
        ...
        <Link href="/checkout" className="w-full py-4 bg-gray-900 hover:bg-gray-800 active:scale-[0.98] text-white font-bold text-sm rounded-xl transition-all tracking-wide text-center">
         checkout
        </Link>
       </div>
      </div>
