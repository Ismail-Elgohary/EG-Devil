...
export default function ProductCard({
 ...
 const productId = Number(post.id);
 ...
 return (
  ...
  >
   ...
   <div className="relative flex items-center justify-center p-3 overflow-hidden shadow-sm">
    ...
    <button
     onClick={() => toggleFavourite(productData)}
     className={`absolute top-2 right-2 z-20 p-1.5 rounded-full transition-all duration-200 ${isFavourite(productId)
   ...
   <div className="p-3 flex flex-col flex-1 gap-1.5">
    ...
    <div className="flex gap-3 mt-1">
     ...
     <button
      ...
      className={`px-4 py-2.5 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95 ${isInCart(productId)
