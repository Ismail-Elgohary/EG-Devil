  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
   <div className="bg-white rounded-4xl shadow-2xl overflow-hidden max-w-5xl w-full flex flex-col md:flex-row">
    ...
    <div className="md:w-1/2 p-10 flex flex-col justify-center gap-5">
     ...
     <Link href="/checkout" className="mt-4 w-full md:w-fit bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold py-3 px-8 rounded-2xl transition-all duration-200 shadow-lg shadow-indigo-200">
      Bye Now
     </Link>
    </div>
   </div>
