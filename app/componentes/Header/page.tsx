...
export default function Header() {
 ...
 return (
  <header className="fixed top-0 left-0 w-full z-50 shadow-sm font-bold bg-gray-900">
   ...
   {open && (
    <div className="md:hidden border-gray-800 px-6 py-6 flex flex-col gap-4 bg-[#1A1A1A] text-white">
     ...
     >
      Products
      <ChevronDown
       className={`w-5 h-5 transition-transform duration-300 ${mobilelist ? "rotate-180" : ""
        }`}
      />
     </button>
