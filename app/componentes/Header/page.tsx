  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 shadow-sm font-bold bg-[#1A1A1A]">
      <div className="px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        {/* 2. الروابط (تظهر في اللاب توب فقط) */}
        ...
        {/* 3. منطقة الأيقونات والمنيو (تظهر في كل الشاشات) */}
        <div className="flex items-center gap-2 md:gap-4 ml-auto md:ml-0">
          {/* تم إزالة الـ hidden هنا لتظهر في الموبايل */}
          <div className="flex items-center">
            <Icons />
          </div>

          {/* فاصل بسيط يظهر في اللاب توب فقط */}
      ...
      {/* المنيو بتاعة الموبايل عند الفتح */}
      {open && (
